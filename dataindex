        ...
        <div id="section1" class="section">
            ...
            <table border="1">
                <tr>
                    ...
                    <td rowspan="3">
                        <input type="file" id="photo_upload" name="photo_upload" accept="image/*" onchange="previewPhoto()" required>
            ...
            <table border="1" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="emergency_relationship" maxlength="15" required></td>
                    <td><input type="tel" name="emergency_contact" maxlength="10" required></td>
            ...
            <table border="1" style="width: 100%;">
                ...
                {% for _ in range(6) %}
                <tr>
                    <td><input type="text" name="family_name" maxlength="30"></td>
                    <td><input type="date" name="family_dob"></td>
                    <td>
                   ...
                   <td>
                       <select name="family_occupation" required>
                           <option value="">Select</option>
                    ...
                    <td><input type="number" name="family_income"></td>
                </tr>
                {% endfor %}
            </table>
            <br><br>
            <table border="1" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="degree_xii/diploma"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="specialization_xii/diploma"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="institution_xii/diploma" required></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="board_xii" required></td>
                ...
                <tr>
                    ...
                    <td><input type="date" name="year_xii/diploma" required</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="percentage_xii/diploma" maxlength="3" required></td>
            ...
            <table border="1" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="last_salary" maxlength="10"></td>
                    <td><textarea name="reason_leaving" rows="2" cols="20"></textarea></td>
                </tr>
                {% endfor %}
            </table>
            <br><br>
        ...
        <div id="section2" class="section hidden">
            ...
            <table border="1" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="language_known" value="tamil"> Tamil
                        <input type="checkbox" name="language_known" value="english"> English
                        <input type="checkbox" name="language_known" value="hindi"> Hindi
                        <input type="checkbox" name="language_known" value="other"> Others
                    </td>
                </tr>
            ...
            <table border="1" style="width: 100%;">
                ...
                {% for _ in range(2) %}
                <tr>
                    <td><input type="text" name="reference_name" required></td>
                    <td><input type="text" name="reference_organisation"></td>
                    <td><input type="text" name="reference_designation"></td>
                    <td><input type="number" name="reference_contact" required></td>
                </tr>
                {% endfor %}
            </table>
            <br><br>
